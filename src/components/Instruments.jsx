                                ...
                                <div className="row">
                                    ...
                                    <div className="col">
                                        ...
                                        <div className="form-check form-switch">
                                            <input className="form-check-input" type="checkboxDisabled" id="flexSwitchCheckDefaultDisabled" disabled />
                                            <label className="form-check-label" for="flexSwitchCheckDefaultDisabled">Increase Room Size (Coming Soon)</label>
                                        </div>
                                    </div>
                                </div>
